...
export class BlokusCram {
     ...
     * @param polyominos
     */
    constructor(board, polyominos, blocked = null) {
        this.#board = board;
    ...
    canPlacePolyomino(polyomino, x, y) {
    ...
    tryPlacePolyomino(polyomino, x, y) {
    ...
    mustPlacePolyomino(polyomino, x, y) {
        for (const [polyX, polyY] of polyomino.iterSet()) {
